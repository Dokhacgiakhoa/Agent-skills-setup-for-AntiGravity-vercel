...
🛡️ [How to prevent this in the future]`,
  ...
  update: {
    ...
    description: "Kiểm tra và cập nhật Agent skills setup for AntiGravity lên bản mới nhất.",
    description_En: "Check and update Agent skills setup for AntiGravity to the latest version.",
    icon: "🔄",
...
export const ruleGuides = {
  ...
  "system-update": {
    ...
    trigger: "on_demand",
    icon: "🔄",
    purpose: "Đảm bảo Agent skills setup for AntiGravity luôn ở phiên bản mới nhất, an toàn và đầy đủ tính năng.",
    rules: [
